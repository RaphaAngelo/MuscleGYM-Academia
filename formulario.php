    ...
    if (empty($_POST)) {
      ...
      formulario($nome, $endereco, $cep, $bairro, $cidade, $uf, $celular, $email, $nascimento, $idade, $peso, $altura, $sexo);
        ...
        if($opcao == 'salvar') {
            ...
            $aluno->inserir($aluno->getNome(), $aluno->getEndereco(), $aluno->getCep(), $aluno->getBairro(), $aluno->getCidade(), 
            $aluno->getUF(), $aluno->getCelular(), $aluno->getEmail(), $aluno->getNascimento(), $aluno->getIdade(), $aluno->getPeso(),
            $aluno->getAltura(), $aluno->getSexo(), $aluno->getImc(), $aluno->getResultado() );
